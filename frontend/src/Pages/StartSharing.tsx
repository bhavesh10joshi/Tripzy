...
export function MyTripShare() {
  const [activeSetting, setActiveSetting] = useState<"view" | "edit">("view");
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-stretch animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
            <div className="w-full lg:w-2/5 p-6 md:p-8 bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col justify-between transition-all duration-500 hover:shadow-2xl">
                ...
                <div className="w-full h-14 bg-slate-50 rounded-2xl mt-6 px-4 flex items-center justify-between border border-slate-100 group">
                  <div className="flex items-center gap-3 overflow-hidden mr-2">
                    ...
                    <span className="text-blue-500 font-medium text-sm truncate">
                      https://www.tripzyai.com/itinerary/share
                    </span>
                  </div>
                  <button className="text-blue-500 hover:text-blue-600 font-mono text-xs font-bold bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-xl transition-all active:scale-95 flex-shrink-0 cursor-pointer">
                    Copy
                  </button>
                </div>
                ...
                <div className="w-full mt-10">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center overflow-hidden">
                        <div className={`w-12 h-12 rounded-xl flex justify-center items-center flex-shrink-0 shadow-sm transition-all duration-300 ${
                          activeSetting === "view" ? "bg-green-500 text-white scale-105" : "bg-green-50 text-green-600 group-hover:scale-110"
                        }`}> 
                          <ViewEye />
                        </div>
                      ...
                      <div className={`w-10 h-6 flex items-center rounded-full p-1 transition-all duration-300 flex-shrink-0 ${
                        activeSetting === "view" ? "bg-blue-500 justify-end" : "bg-slate-200 justify-start"
                      }`}>
                    ...
                    >
                      <div className="flex items-center overflow-hidden">
                        <div className={`w-12 h-12 rounded-xl flex justify-center items-center flex-shrink-0 shadow-sm transition-all duration-300 ${
                          activeSetting === "edit" ? "bg-blue-500 text-white scale-105" : "bg-blue-50 text-blue-600 group-hover:scale-110"
                        }`}> 
                          <IconEdit />
                        </div>
                        <div className="ml-4 overflow-hidden">
                      ...
                      <div className={`w-10 h-6 flex items-center rounded-full p-1 transition-all duration-300 flex-shrink-0 ${
                        activeSetting === "edit" ? "bg-blue-500 justify-end" : "bg-slate-200 justify-start"
                      }`}>
                        <div className="bg-white w-4 h-4 rounded-full shadow-md transition-all duration-350" />
                      </div>
                    </div>
              ...
              <div className="mt-12 w-full pt-4">
                <Button text="Save Access Controls" color="blue" textColor="white" size="secondry" />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                  <div className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <h4 className="font-bold text-lg text-white">Amalfi Coast Escape</h4>
                    <span className="text-white/60 font-light text-xs mt-1 block">Italy • Mediterranean</span>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/5 hover:bg-white/10 transition-colors group">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="font-bold text-lg text-white">Oct 14-22, 2026</h4>
                    </div>
                    <span className="text-white/60 font-light text-xs mt-1 block">8 Nights, 9 Days</span>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="font-bold text-lg text-white">Luxury</h4>
                    </div>
                    <span className="text-white/60 font-light text-xs mt-1 block">Premium Concierge Inclusive</span>
                  </div>

                  <div className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/5 hover:bg-white/10 transition-colors">
                    <span className="font-mono text-white/40 text-[0.65rem] font-bold uppercase tracking-widest block mb-2">Trip ID</span>
                    <h4 className="font-mono font-bold text-base text-blue-400 mt-1">#AK456IOUD56</h4>
                  </div>
                </div>
              </div>
